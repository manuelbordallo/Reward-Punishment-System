...
export const RewardForm: React.FC<RewardFormProps> = ({
    ...
    const validateValue = (inputValue: string): boolean => {
        ...
        if (numericValue <= 0) {
            setValueError('El valor debe ser positivo (mayor que 0)');
            return false;
        }
    ...
    const handleSubmit = () => {
        ...
        if (isNameValid && isValueValid) {
            onSubmit(name.trim(), parseInt(value.trim(), 10));
        }
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.inputContainer}>
                <Text style={styles.label}>Valor (puntos)</Text>
                <TextInput
                    style={[
                        styles.input,
            ...
            <View style={styles.buttonContainer}>
                ...
                >
                    <Text style={[
                        ...
                        {loading ? 'Guardando...' : (reward ? 'Actualizar' : 'Crear')}
                    </Text>
                </TouchableOpacity>
            </View>
        </View>
